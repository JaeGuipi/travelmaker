const toastMessages = {
  success: {
    ...
    scheduleRemoved: "일정이 성공적으로 삭제되었습니다.",
  },
  error: {
    login: "로그인에 실패하였습니다.",
    ...
    serverError: "서버 요청에 실패했습니다. 다시 시도해주세요.",
  },
  notify: {
    imageUpload: "이미지는 최대 4개까지 등록 가능합니다.",
    scheduleField: "날짜, 시작 시간, 종료 시간을 선택해주세요.",
    scheduleStartTime: "시작 시간은 종료 시간보다 이전이어야 합니다.",
    newSchedule: "겹치는 시간대가 있습니다. 다른 시간대를 선택해주세요.",
    reservationExists: "해당 시간대에 예약 내역이 있어 삭제할 수 없습니다.",
  },
};
