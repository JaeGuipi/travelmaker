...
![localhost_3000_](https://github.com/user-attachments/assets/139103f0-a86a-4acc-bf23-bb58fc5e22a5)
 
### 🍀 <a href="https://www.notion.so/FE_9-_-142d6d6479a88050b308ec0292c235df">TRAVEL MAKER 프로젝트 과정 둘러보기</a>
...
|검색 페이지 <br/>예약 현황 페이지 <br />간편 회원가입 구현 <br/>middleware 구현 <br/>fullcalendar 커스텀|메인 페이지<br /> 체험 상세 페이지<br /> 리뷰 구현<br /> 지도 SDK 기능 구현 <br />fullcalendar 커스텀|로그인 페이지<br /> 내 프로필 페이지<br /> 내 체험 등록 및 수정 페이지 <br /> 지도 SDK 기능 구현<br />datepicker 커스텀|회원가입 페이지<br /> 예약 내역 페이지<br /> 내 체험 관리 페이지<br /> 후기 작성 모달 구현<br /> 알림 구현|
